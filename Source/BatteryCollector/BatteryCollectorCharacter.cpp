...
ABatteryCollectorCharacter::ABatteryCollectorCharacter()
{
	...
	// Set a base power lvl for the character
	InitialPower = 2000.0f;
	CharacterPower = InitialPower;

	// Set the dependence of the speed on the power lvl
	SpeedFactor = 0.75f;
	BaseSpeed = 10.0f;
}
...
void ABatteryCollectorCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Pickup collection functionality
...
void ABatteryCollectorCharacter::CollectPickups()
{
	...
	for (int32 i = 0; i < CollectedActors.Num(); ++i)
	{
		...
		{
			// Call the pickup's wasCollected() f'n
...
// Returns initial power of character
float ABatteryCollectorCharacter::GetInitialPower()
{
	return InitialPower;
}

// Returns current power of character
float ABatteryCollectorCharacter::GetCurrentPower()
{
	return CharacterPower;
}

// Update current power of character based on PowerChange

...
public:
	 ...
	 *@param PowerChange: amount to change power by, positive or negative
	 */
...
protected:
	...
	// Starting power lvl of our character
	...
	// Speed whent the character's power lvl == 0
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Power", Meta = (BlueprintProtected = "true"))
	float BaseSpeed;
...
private:
	// Current power lvl of our character
